...
#include "mpros2_msg/msg/detail/hand_point__rosidl_typesupport_fastrtps_c.h"
...
using _HandPoint__ros_msg_type = mpros2_msg__msg__HandPoint;
...
{
  const _HandPoint__ros_msg_type * ros_message = static_cast<const _HandPoint__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mpros2_msg__msg__HandPoint;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mpros2_msg__msg__HandPoint * ros_message = static_cast<const mpros2_msg__msg__HandPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mpros2_msg__msg__HandPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mpros2_msg__msg__HandPoint * ros_message = static_cast<mpros2_msg__msg__HandPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mpros2_msg__msg__HandPoint(cdr, ros_message);
}

static uint32_t _HandPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mpros2_msg__msg__HandPoint(
...
static size_t _HandPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mpros2_msg__msg__HandPoint(
...
static message_type_support_callbacks_t __callbacks_HandPoint = {
  "mpros2_msg::msg",
  "HandPoint",
...
static rosidl_message_type_support_t _HandPoint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HandPoint,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpros2_msg, msg, HandPoint)() {
  return &_HandPoint__type_support;
}
