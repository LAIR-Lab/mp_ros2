...
bool media_pipe_ros2_msg__msg__media_pipe_human_face_mesh_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("media_pipe_ros2_msg.msg._media_pipe_human_face_mesh_list.MediaPipeHumanFaceMeshList", full_classname_dest, 83) == 0);
  }
  media_pipe_ros2_msg__msg__MediaPipeHumanFaceMeshList * ros_message = _ros_message;
  {  // num_humans
...
PyObject * media_pipe_ros2_msg__msg__media_pipe_human_face_mesh_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("media_pipe_ros2_msg.msg._media_pipe_human_face_mesh_list");
