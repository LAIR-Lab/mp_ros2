...
static const _MediaPipeHumanPoseList_type_support_symbol_names_t _MediaPipeHumanPoseList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, media_pipe_ros2_msg, msg, MediaPipeHumanPoseList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, media_pipe_ros2_msg, msg, MediaPipeHumanPoseList)),
  }
};
...
get_message_type_support_handle<media_pipe_ros2_msg::msg::MediaPipeHumanPoseList>()
{
  return &::media_pipe_ros2_msg::msg::rosidl_typesupport_cpp::MediaPipeHumanPoseList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, media_pipe_ros2_msg, msg, MediaPipeHumanPoseList)() {
  return get_message_type_support_handle<media_pipe_ros2_msg::msg::MediaPipeHumanPoseList>();
}
