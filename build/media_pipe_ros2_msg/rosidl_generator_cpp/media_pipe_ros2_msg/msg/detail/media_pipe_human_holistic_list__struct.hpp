...
#ifndef MEDIA_PIPE_ROS2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_HOLISTIC_LIST__STRUCT_HPP_
#define MEDIA_PIPE_ROS2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_HOLISTIC_LIST__STRUCT_HPP_
...
#include "media_pipe_ros2_msg/msg/detail/media_pipe_human_hand__struct.hpp"
...
#ifndef _WIN32
# define DEPRECATED__media_pipe_ros2_msg__msg__MediaPipeHumanHolisticList __attribute__((deprecated))
#else
# define DEPRECATED__media_pipe_ros2_msg__msg__MediaPipeHumanHolisticList __declspec(deprecated)
#endif
...
struct MediaPipeHumanHolisticList_
{
  ...
  : human_hand_list(_init)
  {
    ...
    {
      this->num_humans = 0l;
      this->human_face_mesh_list.fill(media_pipe_ros2_msg::msg::FaceMeshPoint_<ContainerAllocator>{_init});
    ...
    human_pose_list(_alloc)
  {
    ...
    {
      this->num_humans = 0l;
      this->human_face_mesh_list.fill(media_pipe_ros2_msg::msg::FaceMeshPoint_<ContainerAllocator>{_alloc, _init});
  ...
  using _human_hand_list_type =
    media_pipe_ros2_msg::msg::MediaPipeHumanHand_<ContainerAllocator>;
  _human_hand_list_type human_hand_list;
  using _human_face_mesh_list_type =
    std::array<media_pipe_ros2_msg::msg::FaceMeshPoint_<ContainerAllocator>, 468>;
  ...
  Type & set__human_hand_list(
    const media_pipe_ros2_msg::msg::MediaPipeHumanHand_<ContainerAllocator> & _arg)
  {
    this->human_hand_list = _arg;
    return *this;
  }
  Type & set__human_face_mesh_list(
    const std::array<media_pipe_ros2_msg::msg::FaceMeshPoint_<ContainerAllocator>, 468> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> *;
  using ConstRawPtr =
    const media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__media_pipe_ros2_msg__msg__MediaPipeHumanHolisticList
    std::shared_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__media_pipe_ros2_msg__msg__MediaPipeHumanHolisticList
    std::shared_ptr<media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<ContainerAllocator> const>
...
using MediaPipeHumanHolisticList =
  media_pipe_ros2_msg::msg::MediaPipeHumanHolisticList_<std::allocator<void>>;
...
#endif  // MEDIA_PIPE_ROS2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_HOLISTIC_LIST__STRUCT_HPP_
