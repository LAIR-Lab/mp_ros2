...
static const _MediaPipeHumanFaceMeshList_type_support_symbol_names_t _MediaPipeHumanFaceMeshList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, media_pipe_ros2_msg, msg, MediaPipeHumanFaceMeshList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, media_pipe_ros2_msg, msg, MediaPipeHumanFaceMeshList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, media_pipe_ros2_msg, msg, MediaPipeHumanFaceMeshList)() {
  return &::media_pipe_ros2_msg::msg::rosidl_typesupport_c::MediaPipeHumanFaceMeshList_message_type_support_handle;
}
