...
#ifndef mpros2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_POSE_LIST__STRUCT_HPP_
#define mpros2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_POSE_LIST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mpros2_msg__msg__MediaPipeHumanPoseList __attribute__((deprecated))
#else
# define DEPRECATED__mpros2_msg__msg__MediaPipeHumanPoseList __declspec(deprecated)
#endif
...
struct MediaPipeHumanPoseList_
{
  ...
  // pointer types
  using RawPtr =
    mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> *;
  using ConstRawPtr =
    const mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mpros2_msg__msg__MediaPipeHumanPoseList
    std::shared_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mpros2_msg__msg__MediaPipeHumanPoseList
    std::shared_ptr<mpros2_msg::msg::MediaPipeHumanPoseList_<ContainerAllocator> const>
...
using MediaPipeHumanPoseList =
  mpros2_msg::msg::MediaPipeHumanPoseList_<std::allocator<void>>;
...
#endif  // mpros2_MSG__MSG__DETAIL__MEDIA_PIPE_HUMAN_POSE_LIST__STRUCT_HPP_
